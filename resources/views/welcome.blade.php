...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Servion | Landing, Responsive &amp; Business Templatee</title>
  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-4 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="index.html"><img src="{{ asset('img/') }}/gallery/logo.png" height="24" alt="..." /></a>
      ...
      <section id="home">
        <div class="bg-holder" style="background-image:url('http://localhost:8000/img/gallery/hero.png');background-position:center;background-size:cover;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container">
          <div class="row align-items-center min-vh-50 min-vh-sm-75">
            ...
            <div class="col-md-5 col-lg-6 order-0 order-md-1"><img class="w-100" src="{{ asset('img/') }}/illustrations/hero-header.png" alt="..." /></div>
      ...
      <section class="pt-8">
        ...
        <div class="container">
          ...
          <div class="row align-items-center mt-5">
            <div class="col-md-5 col-lg-6 order-md-1 order-0"><img class="w-100" src="{{ asset('img/') }}/gallery/join-us.png" alt="" /></div>
            <div class="col-md-7 col-lg-6 pe-lg-4 pe-xl-7">
              <div class="d-flex align-items-start"><img class="me-4" src="{{ asset('img/') }}/icons/give-a-care.png" alt="" width="30" />
                <div class="flex-1">
              ...
              <div class="d-flex align-items-start"><img class="me-4" src="{{ asset('img/') }}/icons/tweak-as-you.png" alt="" width="30" />
                <div class="flex-1">
              ...
              <div class="d-flex align-items-start"><img class="me-4" src="{{ asset('img/') }}/icons/security.png" width="30" alt="..." />
                <div class="flex-1">
          ...
          <div class="row h-100">
            <div class="col-md-6 mb-5 mb-md-0 h-100">
              <div class="card card-span bg-primary h-100">
                <div class="card-body p-4">
                  <div class="d-flex justify-content-between"><img class="mb-3" src="{{ asset('img/') }}/icons/rocket.png" height="80" alt="..." /><img src="{{ asset('img/') }}/icons/clouds-1.png" height="90" alt="..." /></div>
            ...
            <div class="col-md-6 h-100">
              <div class="card bg-secondary card-span h-100">
                <div class="card-body p-4">
                  <div class="d-flex justify-content-between"><img class="mb-3" src="{{ asset('img/') }}/icons/servion.png" height="80" alt="..." /><img src="{{ asset('img/') }}/icons/logos.png" height="90" alt="..." /></div>
          ...
          <div class="row h-100">
            <div class="col-sm-6 col-xl-3 mb-3">
              <div class="card card-span shadow py-4 h-100 border-top border-4 border-primary">
                <div class="card-body">
                  <div class="text-center"><img src="{{ asset('img/') }}/icons/shared-hosting.png" alt="..." />
            ...
            <div class="col-sm-6 col-xl-3 mb-3">
              <div class="card card-span shadow py-4 h-100 border-top border-4 border-primary">
                <div class="card-body">
                  <div class="text-center"><img src="{{ asset('img/') }}/icons/vpn-hosting.png" alt="..." />
            ...
            <div class="col-sm-6 col-xl-3 mb-3">
              <div class="card card-span shadow py-4 h-100 border-top border-4 border-primary">
                <div class="card-body">
                  <div class="text-center"><img src="{{ asset('img/') }}/icons/cloud-hosting.png" alt="..." />
            ...
            <div class="col-sm-6 col-xl-3 mb-3">
              <div class="card card-span shadow py-4 h-100 border-top border-4 border-primary">
                <div class="card-body">
                  <div class="text-center"><img src="{{ asset('img/') }}/icons/wp-hosting.png" alt="..." />
      ...
      <section class="py-8" id="team">
        <div class="bg-holder" style="background-image:url('http://localhost:8000/img/gallery/testimonial-bg.png');background-position:center;background-size:cover;">
        </div>
        <!--/.bg-holder-->
              ...
              <div class="carousel-item active" data-bs-interval="10000">
                <div class="row h-100">
                  <div class="col-lg-6 mb-3 mb-md-0">
                    <div class="card card-span h-100 bg-transparent">
                      <div class="card-body my-2">
                        <div class="d-sm-flex"><img class="img-fluid me-3 me-md-2 me-lg-3" src="{{ asset('img/') }}/gallery/mark.png" height="100" alt="..." />
                  ...
                  <div class="col-lg-6 mb-3 mb-md-0">
                    <div class="card card-span h-100 bg-transparent">
                      <div class="card-body my-2">
                        <div class="d-sm-flex"><img class="img-fluid me-3 me-md-2 me-lg-3" src="{{ asset('img/') }}/gallery/emily.png" height="100" alt="..." />
                          <div class="flex-1 ps-2">
                            <svg class="bi bi-star-fill" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#FFCC00" viewBox="0 0 16 16">
                              <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.283.95l-3.523 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"></path>
                            </svg>
      ...
      <section class="pb-lg-0 pt-md-8 py-0">
        ...
        <div class="container">
          <div class="row align-items-center justify-content-xl-between py-5 border-klean">
            <div class="col-auto col-md-4 col-lg-auto my-3 text-xl-start"><img src="{{ asset('img/') }}/gallery/robinhood.png" height="40" alt="..." /></div>
            <div class="col-auto col-md-4 col-lg-auto my-3 text-xl-start"><img src="{{ asset('img/') }}/gallery/reddit.png" height="40" alt="..." /></div>
            <div class="col-auto col-md-4 col-lg-auto my-3 text-xl-start"><img src="{{ asset('img/') }}/gallery/upcase.png" height="40" alt="..." /></div>
            <div class="col-auto col-md-4 col-lg-auto my-3 text-xl-start"><img src="{{ asset('img/') }}/gallery/hubspot.png" height="40" alt="..." /></div>
            <div class="col-auto col-md-4 col-lg-auto my-3 text-xl-start"><img src="{{ asset('img/') }}/gallery/tunein.png" height="40" alt="..." /></div>
          </div>
        </div>
        <!-- end of .container-->
      ...
      <section class="py-0 py-xxl-6" id="help">
        <div class="bg-holder" style="background-image:url('http://localhost:8000/img/gallery/footer-bg.png');background-position:center;background-size:cover;">
        </div>
        <!--/.bg-holder-->
          ...
          <div class="row min-vh-75 min-vh-xl-50 pt-10">
            ...
            <div class="col-xl-3 mb-3">
              ...
              <ul class="list-unstyled list-inline mb-6 mb-md-0">
                <li class="list-inline-item mr-2"><a class="text-decoration-none" href="#!"><img class="list-social-icon" src="{{ asset('img/') }}/gallery/visa.png" width="50" alt="..." /></a></li>
                <li class="list-inline-item mr-2"><a class="text-decoration-none" href="#!"><img class="list-social-icon" src="{{ asset('img/') }}/gallery/master-card.png" width="50" alt="..." /></a></li>
                <li class="list-inline-item mr-2"><a class="text-decoration-none" href="#!"><img class="list-social-icon" src="{{ asset('img/') }}/gallery/union-pay.png" width="50" alt="..." /></a></li>
                <li class="list-inline-item"><a class="text-decoration-none" href="#!"><img class="list-social-icon" src="{{ asset('img/') }}/gallery/express.png" width="50" alt="..." /></a></li>
              </ul>
            </div>
          </div>
          <hr />
